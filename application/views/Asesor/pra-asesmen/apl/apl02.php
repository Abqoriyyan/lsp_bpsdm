...
<body>
    ...
    <!-- DataTales Example -->
    <a href="<?= base_url('asesor/pra_asesmen/') . base64_encode($id_izin); ?>" class="btn btn-primary">Kembali ke
        Pra-Asesmen</a><br /><br />
    <div class="card shadow mb-4">
        ...
        <div class="container">
            ...
            <!-- Signature -->
            <div class="container">
                <iframe src="<?= base_url('asesor/cetak_form_apl02/') . base64_encode($id_izin); ?>" frameborder="0"
                    width="100%" height="600px"></iframe>
                <b>Catatan : <i>Signature / TTD di bawah ini akan digunakan untuk keperluan Tanda Tangan pada Form APL
                        02</i></b><br /><br />
                <div class="row">
                    <div class="col-md-6">
                        <section>
                                ...
                                <div class="boxarea">
                                    <div class="signature-pad" id="signature-pad">
                                        ...
                                        <div class="m-signature-pad-footer" style="margin-top:3px;">
                                            <center><button type="button" id="save2" data-action="save"
                                                    onclick="return confirm('Simpan Signature / TTD ?')"
                                                    class="btn btn-primary"><i class="fa fa-check"></i> Save</button>
...
<script>
    ...
    saveButton.addEventListener("click", function (event) {
        ...
        if (confirm('Simpan Signature / TTD ?')) {
            $.ajax({
                type: "POST",
                url: "<?= base_url(); ?>asesor/insert_signature_asesor_apl02/<?= base64_encode($id_izin) ?>",
                data: {
