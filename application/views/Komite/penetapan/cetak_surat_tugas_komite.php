...
<head>
    ...
    <title>Surat Tugas Komite - <?= $id_izin ?></title>
...
<body>
    ...
    <div style="margin:30px; margin-top:-50px;">
        <h4 style="text-align:center;">SURAT PERINTAH TUGAS<br />
            ...
            NOMOR : <?= $get_data_penetapan_komite_lpjk->no_surat_tugas; ?>
            /SPT/LSP/<?= getRomawi(date('n', strtotime($get_data_pencatatan->tanggal_ditetapkan))) ?>/<?= substr($get_data_pencatatan->nomor_registrasi_lsp, -4); ?>
        </h4>
    </div>

    <div style="margin:80px; margin-top:40px;">
        Dengan ini Lembaga Sertifikasi Profesi <?= $get_data_lsp->username; ?> menugaskan kepada Komite Pengambilan
        Keputusan (Komite Teknis), sbb :
        <table style="width:100%; text-align:justify; font-size:15px;   border-spacing: 0 15px;">
            <tr>
                ...
                <td style="width:65%; vertical-align: baseline;">
                    <?= $get_data_penetapan_komite_lpjk->nama_komite_teknis; ?></td>
            </tr>
            <tr>
                <td style="width:30%; vertical-align: baseline;">Jabatan</td>
                <td style="width:5%; vertical-align: baseline;"> : </td>
                <td style="width:65%; vertical-align: baseline;">
                    <?= $get_data_penetapan_komite_lpjk->jabatan_komite_teknis; ?></td>
            </tr>
            <tr>
        ...
        <p style="text-align:right;">Dikeluarkan pada Tanggal
            <?= tanggal_indo($get_data_penetapan_komite_lpjk->tgl_surat_tugas); ?></p>
        <br /><br /><br />
