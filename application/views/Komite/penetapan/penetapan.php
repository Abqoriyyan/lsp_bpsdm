...
<body>
    ...
    <center>
        <h4 class="text-center"><b>Penetapan Komite Teknis Permohonan Sertifikasi</b></h4>
    </center>
    <div class="row shadow mb-4">
            ...
            <div class="card-body ">
                <div class="tab-content">
                    ...
                    <div class="tab-pane active container" id="administrasi">
                        <h5 class="text-center">Data Administrasi</h5>
                        <hr />
                        <table class="text" width="100%" border="0" cellspacing="0" cellpadding="3">
                            ...
                            <tr>
                                ...
                                <th width="2%">:</th>
                                <th width="78%">
                                    <?= $get_data_personal_permohonan->tempat_lahir . ', ' . $get_data_personal_permohonan->tanggal_lahir ?>
                                </th>
                            </tr>
                            <tr>
                    ...
                    <div class="tab-pane" id="pendidikan">
                        <h5 class="text-center">Pendidikan Yang dipilih sesuai Dengan Kompetensi Permohonan</h5>
                        <hr />
                        <table class="table-responsive table table-bordered" id="dataTable" width="100%" border="1"
                            ...
                            <tr>
                                ...
                                <td class="text-center"><?php echo $get_data_pendidikan_permohonan->program_studi; ?>
                                </td>
                        ...
                        <table class="table-responsive table table-bordered" id="dataTable" width="100%" border="1"
                            ...
                            foreach ($get_data_pelatihan_permohonan as $data_pelatihan) {
                                ...
                                <tr>
                                    ...
                                    <td width="10%" class="text-center"><?php echo $data_pelatihan['jumlah_hari'] . ' Hari'; ?>
                                    </td>
                    ...
                    <div class="tab-pane" id="apl01">
                        ...
                        <div class="container">
                            <iframe src="<?= base_url('komite/cetak_form_apl01/') . base64_encode($id_izin); ?>"
                    ...
                    <div class="tab-pane" id="apl02">
                        ...
                        <div class="container">
                            <iframe src="<?= base_url('komite/cetak_form_apl02/') . base64_encode($id_izin); ?>"
                                frameborder="0" width="100%" height="600px"></iframe>
                        </div>
                    </div>
                    <!------------------------ / Apl02 ------------------------------>
        ...
        foreach ($get_data_rekomendasi_asesor as $data_rekomendasi_asesor) {
            ...
            <div class="col-sm-6 card"><br />
                <h6 class="text-center">Asesor ke-<?= $data_rekomendasi_asesor['asesor_ke'] ?> (
                    <?= $data_rekomendasi_asesor['nama']; ?> - <?= $data_rekomendasi_asesor['id_asesor']; ?>)</h6>
                <hr />
                        ...
                        if ($data_file_asesmen['user_pengunggah'] == $data_rekomendasi_asesor['id_asesor']) {
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url('uploads/file_asesmen/') . $data_file_asesmen['kode_form'] . '/' . $data_file_asesmen['file'] ?>"
                                            target="_blank"><i class="fas fa-fw fa-eye"></i> View File</a></a>
                                    </td>
                                </tr>
                            </tbody>
                        <?php
                ...
                <form action="<?= base_url("Komite/insert_penetapan/") . base64_encode($id_izin); ?>" method="POST"
                    ...
                    <div class="col-sm-4 text-center">
                        ...
                        <select class="form-control text-center"
                            style="border:1px solid #111; box-shadow: 2px 4px #9999;" name="penetapan" required>
                            <option value="Kompeten">Kompeten - Cetak Sertifikat</option>
                            <option value="Belum Kompeten">Belum Kompeten - Tolak Permohonan</option>
                        </select>
                    </div><br />
                    <div class="col-sm-4">
                        <textarea name="catatan" class="form-control" placeholder="Catatan..."
                            style="border:1px solid #111; box-shadow: 2px 4px #9999; text-align:center;"></textarea>
                    </div><br />
                    <div class="col-sm-12 text-center"><br />
                        <input type="submit" value="Tetapkan Hasil Sertifikasi" class="btn btn-default"
                            style="background-color:#0295da; color:#fff;"
