                ...
                <div class="col-sm-12">
                            ...
                            <table border="0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h6 class="card-title"> <?= $info_data_permohonan->deskripsi_kualifikasi ?>
                                            </h6>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <h6 class="card-title"><?= $info_data_permohonan->subklasifikasi ?>(
                                                <?= $info_data_permohonan->deskripsi_subklasifikasi ?> )</h6>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="15%">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <h6 class="card-title"> <?= $info_data_permohonan->jabatan_kerja ?>(
                                                <?= $info_data_permohonan->deskripsi_jabatan_kerja ?> )</h6>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="15%">
                                        ...
                                        <td>
                                            <h6 class="card-title">
                                                <?= $info_data_permohonan->deskripsi_jenis_permohonan; ?></h6>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="15%">
                                        ...
                                        <td>
                                            <h6 class="card-title"><?= $info_data_permohonan->kode_tuk; ?> -
                                                <?= $info_data_permohonan->nama_tuk; ?></h6>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="table-responsive card mb-6 py-3 border-bottom-info">
                        ...
                        <div class="card-header">
                            1. Asesor yang muncul merupakan, Asesor yang subklasifikasinya sesuai dengan Kompetensi
                            subklasifikasi yang dimohon<br />
                            2. Asesor yang dimunculkan tidak akan lebih jenjang yang di ampu dari jenjang
                            permohonan<br />
                            3. TUK yang dipilih merupakan TUK yang sudah divalidasi ke BNSP dan masa berlaku TUK masih
                            aktif<br /></div>
                    </div><br />

                    <form action="<?= base_url('Admin/insert_penunjukan_asesor/') . base64_encode($id_izin); ?>"
                        method="POST">
                        ...
                        <div class="row">
                            ...
                            if ($info_data_permohonan->jenjang <= '3') {
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <select name="asesor1" id='select_box' class="form-select " style="font-size:12px;"
                                            required>
                            ...
                            <?php } elseif ($info_data_permohonan->jenjang >= '4') {
                                ...
                                <div class="container" style="width:50%">
                                    <div class="form-group">
                                        ...
                                        <select name="asesor2" id='select_box1' class="form-select " style="font-size:12px;"
                                            required>
                                            <option value="">Pilih Asesor</option>
                                            <?php
                                            foreach ($get_list_asesor as $data_asesor) {
                            ...
                            <div class="container">
                                <div class="form-group">
                                    ...
                                    <select name="kode_jadwal_asesmen" class="form-select " style="font-size:12px;"
                                        required>
                                        <?php
                        ...
                        <div class="text-center">
                            <input type="submit" value="Tunjuk Asesor" class="btn btn-primary"
                                onclick="return confirm('Apakah sudah Benar untuk Data Penunjukan Asesornya?')">
                        </div><br />
                    </form>
                </div>
            </div>
