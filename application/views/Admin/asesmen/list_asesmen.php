    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 card-header-custom">
            <h6 class="m-0 font-weight-bold text-white">
                <i class="fas fa-user-check mr-1"></i> Absensi Asesmen
            </h6>
        </div>
        <div class="card-body">
                        ...
                        if (!empty($list_jadwal)):
                            foreach ($list_jadwal as $row):
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url('Admin/form_asesmen/' . base64_encode($row['kode_jadwal'])); ?>"
                                            class="btn btn-success btn-sm"> Kelola Absensi
                                        </a>
                                    </td>
                                </tr>
                                <?php
