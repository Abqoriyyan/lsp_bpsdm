<head>
    ...
    <title>File Absen Asesmen</title>
</head>
<style>
    .table-compact th,
    .table-compact td {
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 card-header-custom">
            <h6 class="m-0 font-weight-bold text-white">
                <i class="fas fa-file-upload mr-2"></i>Absensi Asesmen
            </h6>
        </div>
        <div class="card-body">

            <form action="<?= base_url('Admin/simpan_absensi_asesmen'); ?>" method="POST" enctype="multipart/form-data">
            ...
            <?php if (!empty($get_absen_terakhir)): ?>
                <div class="p-3 border-left-info rounded bg-white shadow-sm border"
                    ...
                    <a href="<?= base_url('uploads/absensi_asesmen/' . $get_absen_terakhir->file_absen); ?>" target="_blank"
